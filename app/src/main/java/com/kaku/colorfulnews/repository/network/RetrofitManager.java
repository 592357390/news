...
import com.kaku.colorfulnews.mvp.entity.ShowNewsBean;
...
public class RetrofitManager {
    ...
    public Observable<ShowNewsBean> getIsShowNews(String photoPath) {
        return mNewsService.getIsShowNews(photoPath);
    }
